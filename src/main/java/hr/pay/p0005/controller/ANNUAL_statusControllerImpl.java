package hr.pay.p0005.controller;
...
import hr.pay.p0005.service.ANNUAL_statusService;
import hr.pay.p0005.vo.ANNUAL_statusVO;




@Controller("ANNUAL_statusController")
public class ANNUAL_statusControllerImpl implements ANNUAL_statusController {
	private static final Logger logger = LoggerFactory.getLogger(ANNUAL_statusControllerImpl.class);
	@Autowired
	ANNUAL_statusService ANNUAL_statusService;
	@Autowired
	ANNUAL_statusVO ANNUAL_statusVO;
	
	@Override
	@RequestMapping(value = "/pay/p0005/init.do", method = { RequestMethod.GET, RequestMethod.POST })
	public ModelAndView searchInit(HttpServletRequest request, HttpServletResponse response) throws Exception {
		request.setCharacterEncoding("utf-8");
		//ModelAndView main = new ModelAndView("hr/p0001_init");
		ModelAndView main = new ModelAndView("pay/p0005/ANNUAL_status");
		return main;
	}
	
	@Override
	@RequestMapping(value = "/pay/p0005/calendar.do", method = { RequestMethod.GET, RequestMethod.POST })
	public ModelAndView Calendar(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String viewName = getViewName(request);
		viewName = "pay/p0005/calendar";
		request.setCharacterEncoding("utf-8");
		//ModelAndView main = new ModelAndView("hr/p0001_init");
	...
	@Override
	@RequestMapping(value = "/pay/p0005/ANNUAL_status.do", method = { RequestMethod.GET, RequestMethod.POST })
	...
	@Override
	@RequestMapping(value = "/pay/p0005/calendar2.do", method = { RequestMethod.GET, RequestMethod.POST })
	public ModelAndView Calendar2(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String viewName = getViewName(request);
		viewName = "pay/p0005/calendar2";
		request.setCharacterEncoding("utf-8");
		//ModelAndView main = new ModelAndView("hr/p0001_init");
		ModelAndView main = new ModelAndView(viewName);
		return main;
	...
	@Override
	@RequestMapping(value = "/pay/ANNUAL_status/searchList.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public Map searchList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<ANNUAL_statusVO> data = ANNUAL_statusService.searchList(searchMap);
	...
	@Override
	@RequestMapping(value = "/pay/ANNUAL_status/SiteList.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public Map SiteList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//占쎈쑓占쎌뵠占쎄숲 鈺곌퀬?돳
		List<ANNUAL_statusVO> data = ANNUAL_statusService.SiteList(searchMap);
        resultMap.put("Data", data);
	...
	@Override
	@RequestMapping(value = "/pay/ANNUAL_status/DeptList.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public Map DeptList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//占쎈쑓占쎌뵠占쎄숲 鈺곌퀬?돳
		List<ANNUAL_statusVO> data = ANNUAL_statusService.DeptList(searchMap);
        resultMap.put("Data", data);
	...
	@Override
	@RequestMapping(value = "/pay/ANNUAL_status/DeptList2.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public Map DeptList2(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//占쎈쑓占쎌뵠占쎄숲 鈺곌퀬?돳
		List<ANNUAL_statusVO> data = ANNUAL_statusService.DeptList2(searchMap);
        resultMap.put("Data", data);
	...
	@Override
	@RequestMapping(value = "/pay/ANNUAL_status/yearday.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public Map yearday(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//占쎈쑓占쎌뵠占쎄숲 鈺곌퀬?돳
		List<ANNUAL_statusVO> data = ANNUAL_statusService.yearday(searchMap);
        resultMap.put("Data", data);
	...
	@Override
	@RequestMapping(value = "/pay/ANNUAL_status/yeardayd.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public Map yeardayd(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//占쎈쑓占쎌뵠占쎄숲 鈺곌퀬?돳
		List<ANNUAL_statusVO> data = ANNUAL_statusService.yeardayd(searchMap);
        resultMap.put("Data", data);
	...
	@Override
	@RequestMapping(value = "/pay/ANNUAL_status/saveData.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
