...
public class comEnroll_ControllerImpl implements comEnroll_Controller {
	...
	public ModelAndView adcompany_Enroll(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String viewName = getViewName(request);
	...
	@Override
	@RequestMapping(value = "/human/s0001/workplace_Enroll.do", method = { RequestMethod.GET, RequestMethod.POST })
	public ModelAndView workplace_Enroll(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String viewName = getViewName(request);
		viewName = "/human/s0001/workplace_Enroll";
		request.setCharacterEncoding("utf-8");
		//ModelAndView main = new ModelAndView("hr/p0001_init");
		ModelAndView main = new ModelAndView(viewName);
		return main;
	...
	@Override
	@RequestMapping(value = "/human/s0001/dept_Enroll.do", method = { RequestMethod.GET, RequestMethod.POST })
	public ModelAndView dept_Enroll(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String viewName = getViewName(request);
		viewName = "/human/s0001/dept_Enroll";
		request.setCharacterEncoding("utf-8");
		//ModelAndView main = new ModelAndView("hr/p0001_init");
		ModelAndView main = new ModelAndView(viewName);
		return main;
	...
	@Override
	@RequestMapping(value = "/human/s0001/comEnrollView.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public Map comEnrollView(HttpServletRequest request, HttpServletResponse response) throws Exception {
		request.setCharacterEncoding("utf-8");
		Map<String, Object> searchMap = new HashMap<String, Object>(); // 검색조건
		Map<String, Object> resultMap = new HashMap<String, Object>(); // 조회결과
		...
		//데이터 조회
		List<ComEnroll_VO> data = comEnroll_Service.comEnrollView(searchMap);
        resultMap.put("Data", data);
