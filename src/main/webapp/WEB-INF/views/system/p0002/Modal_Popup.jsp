...
/*Sheet 기본 설정 */
	function Loading() {
		...
		initSheet.Cols = [ // 상태, 삭제는 건들면 안됨. SaveName은 VO속성과 동일하게
			...
			{Header:"코드 번호",Type:"Text",SaveName:"pk_person_bc_detai_code_num",MinWidth:70, Align:"Center"},
			{Header:"관리내역 명",Type:"Text",SaveName:"person_bc_detai_mngement_name",MinWidth:180, Align:"Center"},
	...
	function mySheet2_OnClick (Row, Col, Value, CellX, CellY, CellW, CellH, rowType){
   		codeNum = mySheet2.GetCellValue(Row,'pk_person_bc_detai_code_num');
   		codeName = mySheet2.GetCellValue(Row,'person_bc_detai_mngement_name');
   		
   		//console.log(codeNum);
   		//console.log(codeName);
   	}
	
	function Action_popup(code, code_division, id, name, frame){
		...
		case 'list':
			...
			console.log(param);
			mySheet2.DoSearch("${pageContext.request.contextPath}/system/p0002/common_pop.do",param);
			break;
		}
	}
	...
	function fn_Selected() {
		...
		//iframe 값을 자식 요소에게 넘겨주기
  	  	$(frameId).get(0).contentWindow.fn_selectCode(code_num, code_name, code_id, code_nameId);
...
<div class="modal-dialog modal-sm" role="document">
  <div class="modal-content">
		  				<div class="modal-header">
		                    ...
		                    <h4 class="modal-title" id="myModalLabel">관리내역 코드 도움</h4>
		                </div>
