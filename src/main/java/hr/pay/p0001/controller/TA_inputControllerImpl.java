...
public class TA_inputControllerImpl implements TA_inputController {
	...
	@Override
	@RequestMapping(value = "/pay/TA_input/searchList.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@Override
	@RequestMapping(value = "/pay/TA_input/searchList2.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@Override
	@RequestMapping(value = "/pay/TA_input/SiteList.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@Override
	@RequestMapping(value = "/pay/TA_input/DeptList.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@Override
	@RequestMapping(value = "/pay/TA_input/DeptList2.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public Map DeptList2(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<TA_inputVO> data = TA_inputService.DeptList2(searchMap);
        resultMap.put("Data", data);
	...
	@Override
	@RequestMapping(value = "/pay/TA_input/yearday.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@Override
	@RequestMapping(value = "/pay/TA_input/yeardayd.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@Override
	@RequestMapping(value = "/pay/TA_input/saveData.do", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
