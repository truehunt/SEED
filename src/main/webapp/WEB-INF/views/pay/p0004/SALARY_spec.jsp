...
<script language="javascript">
   ...
   /*Sheet 기본 설정 */
    function LoadPage() {
      ...
      var cfg = {FrozenCol:2,MergeSheet:msHeaderOnly };  
      mySheet2.SetConfig(cfg); 
      
      var header = [
          {Text:"지급내역|지급내역",Align:"Center"},
          {Text:"지급항목|지급액",Align:"Center"}
          ];  
   ...
   function doAction(sAction) {
      ...
      case "search": //조회
         if(document.getElementById("SiteList").value == "1"){
            var param = "D_B_PAYMENT_DATE_ATTRIBUT=" + document.getElementById("yearday").value + "&SALARY_CAL_PAYMENTDAY=" + document.getElementById("yeardayd").value +  "&PK_WORKPLACE_CODE=" + document.getElementById("DeptList").value;
         }else if(document.getElementById("SiteList").value == "2"){
            var param = "D_B_PAYMENT_DATE_ATTRIBUT=" + document.getElementById("yearday").value + "&SALARY_CAL_PAYMENTDAY=" + document.getElementById("yeardayd").value +  "&FK_DEPT_CODE=" + document.getElementById("DeptList").value;
         }
       
          //"&FK_SAWON_WORKPLACE_CODE=" + document.getElementById("SiteList").value +
          console.log(param);
         mySheet.DoSearch("${contextPath}/pay/SALARY_spec/searchList.do", param);
      ...
      case "save": // 저장
         ...
         mySheet2.DoSave("${contextPath}/pay/SALARY_spec/saveData.do");
         break;         
      case "insert":
      ...
      case "popprint"://팝업인쇄
			...
			document.getElementById("sheetDIV").style.width = "700px";
			xx = mySheet.GetCellValue(1,4);
				console.log(xx);
			window.open("${pageContext.request.contextPath}/pay/p0004/print.do?dept=" + dept + "&name=" + name,"dept","width=700,height=700,menubar=no,status=no,toolbar=no");
			break;
...
// 기타 이벤트 //마우스 클릭시
   ...
   x = "PK_SAWON_CODE=" + mySheet.GetCellValue(row,2) + "&SALARY_CAL_PAYMENTDAY=" + xy;
      ...
      mySheet2.DoSearch("${pageContext.request.contextPath}/pay/SALARY_spec/searchList2.do",x);
      dept = mySheet.GetCellValue(row,4);
      name = mySheet.GetCellValue(row,3);
   }
   ...
   function selectDept() {
      ...
      $
            .ajax({
               ...
               url : "${contextPath}/pay/SALARY_spec/DeptList.do",//목록을 조회 할 url
          ...
          .ajax({
             ...
             url : "${contextPath}/pay/SALARY_spec/DeptList2.do",//목록을 조회 할 url
...
function yearday() {
    ...
    $.ajax({
             ...
             url : "${contextPath}/pay/SALARY_spec/yearday.do",//목록을 조회 할 url
 ...
 function yeardayd() {
    ...
    $
          .ajax({
             ...
             url : "${contextPath}/pay/SALARY_spec/yeardayd.do",//목록을 조회 할 url
...
<br><br>
      ...
      <!-- left단 사원리스트 -->
            ...
            <div style="height:100%;width:30%;float:left">
               <script type="text/javascript"> createIBSheet("mySheet", "80%", "100%"); selectSite(); </script>
            </div>
          ...
          <div class="ib_product2" id="sheetDIV">
