	   ...
	   //ibtab 생성
		...
		var initData = {};
      	...
      	//{Header:"No",Type:"Seq", Align:"Center"},
		 	...
		 	{Header:"사원명",Type:"Text",SaveName:"sawon_NAME",Width:210, Edit:0},
		 	...
		 	{Header:"사진",Type:"Text",SaveName:"photo",Width:50, Edit:0,Hidden:1},
		 	{Header:"사진삭제",Type:"Button",SaveName:"photo_delete",Edit:0,Width:50,Hidden:1}
      	];
...
// 		mySheet11.DoSearch("${pageContext.request.contextPath}/human/p0001/ISA_sb.do", fk_sb_sawon_code);
	 ...
	 // tab 이동전에 발생
   	...
   	function doAction(sAction) {
	      switch(sAction) {
	         case "list":
	             mySheet.DoSearch("${pageContext.request.contextPath}/deptISA");
	        	 break;
	      }
   }
...
// 				H8 = {'ComboCode':info18,'ComboText':info18}; // 포상/징계명
	...
	function ISA2(){
		$.ajax({ // 
			url : "${contextPath}/deptISA2",//목록을 조회 할 url
			type : "POST",
			dataType : "JSON",
			data: {"pk_SAWON_CODE":x},
			success : function(data) {
				$('input[id=SAWON_NAME]').val(data['Data'][0].SAWON_NAME);
				$('input[id=FK_DEPT_NAME]').val(data['Data'][0].FK_DEPT_NAME);
				$('input[id=RANK_NAME]').val(data['Data'][0].RANK_NAME);
				$('input[id=SAWON_JOIN_DATE]').val(data['Data'][0].SAWON_JOIN_DATE);
				//$('input[id=SAWON_NAME]').val(data['Data'][0].SAWON_NAME);
			},
			error : function(jqxhr, status, error) {
				alert("ISA_에러");
...
<body onload="LoadPage()">
   ...
   <div class="row">
      <div class="col-lg-12">        <!-- 해당 메뉴의 아이콘 -->        <!-- 해당 메인 타이틀(제목) 들어가는 부분 -->
         <h1 class="page-header"><i class="fa fa-group fa-fw"></i> <s:message code="main.per6"/></h1>
      </div>
      <!-- /.col-lg-12 -->
   </div>
		                       		...
		                       		<div class="row form-group">
										...
										<div class="col-sm-3" style="width:100%;">
				                            ...
				                            <div class="col-lg-8" style="margin-left: 15px;">
				                            	<input type="text" class="form-control" id="SAWON_NAME" name="SAWON_NAME" value="" maxlength="20" readonly>
				                            </div>
			                    	...
			                    	<div class="row form-group">
			                    		<div class="col-sm-3" style="width:100%;">
				                            ...
				                            <div class="col-lg-8" style="margin-left: 19px;">
				                            	<input type="text" class="form-control" id="FK_DEPT_NAME" name="FK_DEPT_NAME" value="" readonly>
				                            </div>
			                            </div>
			                            <br><br><br>
			                            <div class="col-sm-3" style="width:100%;">
				                            ...
				                            <div class="col-lg-8" style="margin-left: 19px;">
				                            	<input type="text" class="form-control" id="RANK_NAME" name="RANK_NAME" value="" maxlength="20" readonly>
				                            </div>
			                            </div>
			                            <br><br><br>
			                            <div class="col-sm-3" style="width:100%;">
			                            ...
			                            <div class="col-sm-3" style="width:100%;">
				                            ...
				                            <div class="col-lg-8" style="margin-left: 19px;">
				                            	<input type="text" class="form-control" id="SAWON_JOIN_DATE" name="SAWON_JOIN_DATE" value="" maxlength="20" readonly>
				                            </div>
			                            </div>
			                        </div>
			                        <div class="ib_product" style="width:400px; float:left;">
			                    		<script>createIBSheet("mySheet", "600px", "330px");</script>
