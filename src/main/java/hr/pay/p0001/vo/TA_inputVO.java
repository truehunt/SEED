...
public class TA_inputVO {
	...
	private String ta_WORKPLACE_CODE;
	...
	public String getTa_WORKPLACE_CODE() {
		return ta_WORKPLACE_CODE;
	}



	public void setTa_WORKPLACE_CODE(String ta_WORKPLACE_CODE) {
		this.ta_WORKPLACE_CODE = ta_WORKPLACE_CODE;
	}
