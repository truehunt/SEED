...
=======
		...
		<!-- 부문도움코드 레이어 -->
		<!-- <a href="#layerSector" class="btn-example lightgray">부문 도움코드</a><br>  --> 
		<div class="dim-layer">
   			<div class="dimBg"></div>
		...
		<!-- 사업장도움코드 레이어 -->
		<!-- <a href="#layerWorkplace" class="btn-example lightgray">사업장 도움코드</a><br> -->
		<div class="dim-layer">
   			<div class="dimBg"></div>
